...
(
	...
	Employee_Photo nvarchar(100),
	Employee_Status varchar(12) DEFAULT 'EMPLOYED' CHECK( Employee_Status IN ('EMPLOYED', 'NOT EMPLOYED')) NOT NULL, 
	UserID varchar(100),
	UserPassword varchar(100), -- password in plaintext?? if we encode this we ecould get brownie points from proff
	_Role varchar(18) CHECK(_Role IN ('Department Manager', 'Project Manager',  'Team Leader', 'Team Member')) NOT NULL,
...
(
	...
	Project_Status varchar(10) CHECK(Project_Status IN ('Received', 'Processing', 'Completed')) NOT NULL,
	Project_Active_Status varchar(8) DEFAULT 'ACTIVE' CHECK( Project_Active_Status IN ('ACTIVE', 'INACTIVE')) NOT NULL,
...
INSERT INTO dbo.employees
	(First_Name,Last_Name,Middle_Name,Date_of_Birth,Gender,Contry_Code, Phone_Number,Email,House_Number,Street_Name,City,_State,Zipcode,_Role, UserID,UserPassword, Payrate_per_hr)
	VALUES
	('Tony','Hoang','T','08/21/1992','male',1, 7133672444,'tt.hoang2108@gmail.com','11111','Beechnut Street','Houston','TX','77077', 'Department Manager','tonyhoang92',123456789,200.50),	
	('Emily','Diaz','L','04/12/1980','female',1, 7133452998,'emily.diaz@gmail.com','12580','Boone Road','Sugar Land', 'TX','77089','Department Manager','emilydiaz80',12345678,150.15),
	('Vincenzo','Mcleod','C','12/12/1990','male',1, 7137463578,'vincenzo.mcleod@hotmail.com','10 ','Peg Shop Dr','Logansport', 'IN','46947', 'Department Manager','vincenzomcleod90',12345678,100.5),
	('Dagda','Roxana','R','12/12/1995','female',2, 7137263668,'dagda.roxana@gmail.com','25792 ','Gates St','Bedford', 'OH','44146', 'Department Manager','dagdaroxana95',12345678,12.5),
	('Ethan','Horace','V','03/2/1982','male',2, 7131263578,'ethan.horace@gmail.com','1588 ','Bear Hill Rd','Chichester', 'NH','03258', 'Project Manager','ethanhorace82',12345678,100.5),
	('Garrett','Ginnie','W','05/1/1999','female',1, 7131263999,'garrett.ginnie@gmail.com','130','Stillwater Ave #8','Orono', 'ME','04473', 'Project Manager','garrettginnie99',12345678,105.5),
	('Thomas','Renita','Z','10/11/1993','male',7, 4179673422,'thomas.renita@gmail.com','8520','SE 158th St','Summerfield', 'FL','34491', 'Project Manager','thomasrenita93',12345678,11.5),
	('Indie','Kayley','N','09/11/1988','female',1, 6302139063,'indie.kayley@gmail.com','4031','Lakeside Dr','Hanover Park', 'IL','60133', 'Team Leader','indiekayley88',12345678,12.5)

SELECT * FROM employees
SELECT First_Name,Last_Name ,Middle_Name,Gender, _Role FROM employees
...
INSERT INTO dbo.projects
	(Project_Name, Project_Description, Project_Manager_ID,  Project_Status, Customer_ID,Planned_Start_Date, Budget, Created_By)
	VALUES
	('KURTBOOK', 'Build app for Kurt', 1, 'Processing', 2, GETDATE(), 200, 1),
	('All the single Ladies', 'Build dating website spacificly for lesbians', 1, 'Received', 3, GETDATE(), 1000, 2)
...
INSERT INTO dbo.tasks -- task with no associated project
	(Task_Name, Task_Description, Task_Planned_End_Date, Total_Minutes, Task_Status, Employee_ID)
	VALUES
	('Clean Office', 'Clean the office', DATEADD(day, 5, GETDATE()), 0, 'Delay', 2)
