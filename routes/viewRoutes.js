...
router.get('/statistics', authController.roleCheck, viewController.getStatistics);
router.get('/tasks', authController.roleCheck, viewController.getTasksByEmployee);
